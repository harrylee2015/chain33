...
type Transaction struct {
	...
	HashCache            []byte   `protobuf:"bytes,11,opt,name=hashCache,proto3" json:"hashCache,omitempty"`
	FullHashCache        []byte   `protobuf:"bytes,12,opt,name=fullHashCache,proto3" json:"fullHashCache,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Transaction) GetHashCache() []byte {
	if m != nil {
		return m.HashCache
	}
	return nil
...
func (m *Transaction) GetFullHashCache() []byte {
	if m != nil {
		return m.FullHashCache
	}
	return nil
}
...
var fileDescriptor_2cc4e03d2c28c490 = []byte{
	...
	,
}
